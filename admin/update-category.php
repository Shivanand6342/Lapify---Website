            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto h-100">
                    ...
                    <li class="nav-item">
                        ...
                        <i class="fa fa-shopping-cart"></i> Update Category
                        </a>
                    </li>
                </ul>
                <ul class="navbar-nav">
                ...
                <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
                    ...
                    <div class="row tm-edit-product-row">
                        <div class="col-xl-6 col-lg-6 col-md-12">
                            <form action="update-category-php.php" method="POST" class="tm-edit-product-form">
                                <div class="form-group mb-3">
                                    <label for="title">Category
                                    </label>
                                    <input name="title" type="text" class="form-control validate" style="width: 750px;" value="<?php echo $title; ?>" />
                                </div>
                        </div>
                        <div class="col-12">
